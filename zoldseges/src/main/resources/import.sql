insert into User(familyname, givenname, username, email, password, role) values ('Pisti', 'Nagy', 'pistike', 'pistike@gmail.com', '$2a$04$YDiv9c./ytEGZQopFfExoOgGlJL6/o0er0K.hiGb5TGKHUL8Ebn..', 'ROLE_ADMIN');
insert into User(familyname, givenname, username, email, password, role) values ('Kati', 'Kis', 'Katica', 'katalin@gmail.com', '$2a$04$YDiv9c./ytEGZQopFfExoOgGlJL6/o0er0K.hiGb5TGKHUL8Ebn..', 'ROLE_WORKER');
